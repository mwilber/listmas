...
+ (NSData*)cdv_dataFromBase64String:(NSString*)aString
{
    ...
    void* outputBuffer = CDVNewwBase64Decode([aString UTF8String], [aString length], &outputLength);
...
- (NSString*)cdv_base64EncodedString
{
    size_t outputLength = 0;
    char* outputBuffer =
        CDVNewwBase64Encode([self bytes], [self length], true, &outputLength);
