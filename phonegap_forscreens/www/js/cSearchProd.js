    ...
    $scope.SaveGrocery = function (pName, pPhoto, pUrl) {
        ...
        $scope.db.transaction(function (tx) {
            ...
            tx.executeSql('INSERT INTO tblProd (prodName, prodPhoto, prodUrl, prodUpc) VALUES ( ?, ?, ?, ?)', [pName, pPhoto, pUrl, ''], function(tx, response){
                ...
                tx.executeSql('INSERT INTO tblProdlist (prodId,shoplistId) VALUES ( ?, ?)', [response.insertId,ggActiveList.GetActiveList()], function(){ ggSearchProd.SetSearchProd({}); app.navi.resetToPage('list.html'); }), function(result, error){console.log(error);}; //function(tx, response){
