...
class Friend_Model extends CI_Model
{
	var $table = "tblFriend";
	var $pk = "friendId";
	var $ds = "friendTimeStamp";  //Default sortby field 
	var $rq = "friendSource";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'friendSource' => array('label'=>'Source Id','type'=>'int'),
		 'friendTarget' => array('label'=>'Target Id','type'=>'int'),
		);
