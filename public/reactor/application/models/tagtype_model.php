...
{
	var $table = "tblTagType";
	var $pk = "tagTypeId";
	var $ds = "tagTypeDateAdded";  //Default sortby field 
	var $rq = "tagTypeName";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'tagTypeName' => array('label'=>'Name','type'=>'varchar','constraint'=>50),
		 'tagTypeDateAdded' => array('label'=>'Date Added','type'=>'timestamp'),
		);
