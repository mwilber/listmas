...
class Message_Model extends CI_Model
{
	...
	var $pk = "messageId";
	var $ds = "messageTimeStamp";  //Default sortby field 
	var $rq = "messageSource";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'messageSource' => array('label'=>'Source Id','type'=>'int'),
		 'messageTarget' => array('label'=>'Target Id','type'=>'int'),
		 'messageType' => array('label'=>'Type','type'=>'int'),
		 'messageSubject' => array('label'=>'Subject','type'=>'varchar','constraint'=>50),
		 'messageBody' => array('label'=>'Body','type'=>'varchar','constraint'=>200),
		 'messageImage' => array('label'=>'Image','type'=>'varchar','constraint'=>50),
		 'prodId' => array('label'=>'Product','type'=>'int'),
		 'messageStatus' => array('label'=>'Status','type'=>'int'),
		);
	...
	function Get($options = array()){
		...
		//Join to the profile and product tables
		//$this->db->join('tblProd', 'tblMessage.prodId = tblProd.prodId');
		$this->db->join('tblProfile', 'tblMessage.messageSource = tblProfile.profileId');
