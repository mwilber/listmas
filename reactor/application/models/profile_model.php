...
class Profile_Model extends CI_Model
{
	...
	function GetFriends($pProfileId){
		$sql = "* FROM tblProfile AS tP, tblAccount AS tA, tblFriend AS tF WHERE tP.profileId=tA.profileId AND tP.profileId=tF.friendTarget AND tF.friendSource = ".$pProfileId."";
	...
	function GetByExtId($pProfileId, $pFriendList){
		
		$sql = "* FROM tblProfile AS tP, tblAccount AS tA WHERE tP.profileId=tA.profileId AND tA.accountExtId IN (".$pFriendList.") ";
		$sql .= "AND tP.profileId NOT IN (SELECT friendTarget FROM tblFriend WHERE friendSource=".$pProfileId.")";
