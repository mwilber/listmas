...
class ProfileStore_Model extends CI_Model
{
	var $table = "tblProfileStore";
	var $pk = "profileStoreId";
	var $ds = "profileStoreDateAdded";  //Default sortby field 
	var $rq = "profileId";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'profileId' => array('label'=>'Profile','type'=>'int'),
		 'storeId' => array('label'=>'Store','type'=>'int'),
		 'profileStoreDateAdded' => array('label'=>'Date Added','type'=>'timestamp'),
		);
