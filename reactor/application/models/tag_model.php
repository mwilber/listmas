...
class Tag_Model extends CI_Model
{
	var $table = "tblTag";
	var $pk = "tagId";
	var $ds = "tagDateAdded";  //Default sortby field 
	var $rq = "tagName";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'tagName' => array('label'=>'Name','type'=>'varchar','constraint'=>50),
		 'tagTypeId' => array('label'=>'Type','type'=>'int'),
		 'tagDateAdded' => array('label'=>'Date Added','type'=>'timestamp'),
		);
