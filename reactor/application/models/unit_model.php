...
class Unit_Model extends CI_Model
{
	var $table = "tblUnit";
	var $pk = "unitId";
	var $ds = "unitDateAdded";  //Default sortby field 
	var $rq = "unitName";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'unitName' => array('label'=>'Name','type'=>'varchar','constraint'=>10),
		 'unitDateAdded' => array('label'=>'Date Added','type'=>'timestamp'),
		);
