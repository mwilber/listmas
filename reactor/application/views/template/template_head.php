			...
			<nav>
				<ul>
					<? if( $this->session->userdata('userEmail') ): ?>
						<!-- Add nav elements here --><li><a href="<?= base_url() ?>prodlist" class="prodlist">Prodlist</a></li><li><a href="<?= base_url() ?>shoplist" class="shoplist">Shoplist</a></li><li><a href="<?= base_url() ?>prod" class="prod">Prod</a></li>
